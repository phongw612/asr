    ...
    with tf.Session(graph=graph) as session:
        ...
        for curr_epoch in range(num_epochs):
            ...
            for batch in range(num_batches_per_epoch):
                ...
                batch_cost, _, train_ler_p, d, lo_ori = session.run([cost, optimizer, ler, decoded[0], logits_ori], feed)
                """count = 0
            ...
            d, lo_ori = session.run([decoded[0], logits_ori], feed_dict=val_feed)
